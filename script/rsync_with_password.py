...
print("	[{}] run command {}."
				.format(Name, "RSYNC_PASSWORD=" + os.getenv('PSW_' + Name) + " rsync -rtlvH --safe-links --delete --delete-delay --delay-updates --timeout=600 --contimeout=60 --progress {} {}".format(RemotePath, LocalPath)))
