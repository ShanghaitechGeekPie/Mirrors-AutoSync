...
print("	[{}] run command {}."
				.format(Name, "rsync -pPrtlvH --sparse --safe-links --delete --delete-delay --delay-updates --timeout=60 --contimeout=60 --progress {} {}\n".format(RemotePath, LocalPath)))

writer(-1)

statuscode = os.system("rsync -pPrtlvH --sparse --safe-links --delete --delete-delay --delay-updates --timeout=60 --contimeout=60 --progress {} {}"
