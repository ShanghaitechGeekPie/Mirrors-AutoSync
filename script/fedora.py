...
command_literal = "/Mirrors-AutoSync/script/quick-fedora-mirror --timefile {} --destination-dir {} --upstream {} {}".format(TimefilePath, LocalPath, RemotePath, "" if os.path.exists(TimefilePath) else "-a")
